...
import { BudgetOfficerRequestDetail } from '@/features/budget-officer/components/BudgetOfficerRequestDetail';
    ...
    <div className="min-h-full p-4 sm:p-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <nav className="flex items-center gap-2 text-sm text-gray-500" aria-label="Breadcrumb">
          <Link to="/budget-officer/requests" className="hover:text-gray-900">
            Requests
          </Link>
      ...
      <div className="mt-5">
        ...
        {isError && !isLoading && (
          <div className="rounded-lg bg-white p-8 text-center shadow-sm">
            <p className="text-sm text-destructive">
              ...
              <Link to="/budget-officer/requests" className="underline">
                return to Requests
              </Link>
              .
            </p>
        ...
        {!isLoading && !isError && response?.data && (
          <BudgetOfficerRequestDetail request={response.data} />
        )}
      </div>
    </div>
  );
...
export default BudgetOfficerRequestDetailPage;
