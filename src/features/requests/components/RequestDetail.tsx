...
/**
 * Maps each status to the number of steps that are fully completed.
 * 0 = nothing done, 7 = all done.
 */
...
interface ChainStep {
  label: string;
  /** status_history `to_status` values that mark this step as complete */
...
/** Returns the first history entry whose `to_status` marks this step as done. */
    ...
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_320px]">
      ...
      <div className="flex flex-col gap-6">
        ...
        <SectionCard title="General Information">
          <div className="grid grid-cols-2 gap-x-4 gap-y-5 sm:grid-cols-3 sm:gap-x-8">
      ...
      <div className="flex flex-col gap-6 lg:sticky lg:top-6 lg:self-start">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-6">
          ...
          <div>
            ...
            {/* Placeholder two-segment progress bar */}
            <div
            ...
            <p className="mt-2 text-xs text-gray-500">
              Current Spend{' '}
              <span className="font-medium text-gray-700">(Dark Gray)</span> vs This Request{' '}
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 sm:p-6">
          ...
          <ol>
            {CHAIN_STEPS.map((step, index) => {
              ...
              // Draft (completedCount === 0) keeps all steps as pending — no active step.
